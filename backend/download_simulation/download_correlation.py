...
from db import (
    ...
    save_klines_correlation,
    conectar,
    Delete_all_Klines_correlation,
...
# --------------------------------------------------
def download_historical_klines_correlation(
...
# --------------------------------------------------
def download_and_save_klines_correlation(
    ...
    if date_start and date_end:
        ...
        if (end_dt - start_dt).days > 365:
            ...
            all_klines = download_historical_klines_correlation(
