...
from db import get_timeframe_global,  get_data_klines , get_data_klines_correlation
from klines.klines import get_klines_extended
from indicators.correlation import highest_correlation_value
...
def calculate_vppr_correlation(klines):
    vppr_values = []
    vppr_acumulado = 0
...
# Função para calcular VPPR e sua EMA
...
def get_vppr_correlation(symbol, modo=None, offset=None, limit=None):
    time = get_timeframe_global()
    ...
    vppr_values = calculate_vppr_correlation(klines)
